...
namespace MaybeThisWillWork.HopupContentPages
{
    ...
    public partial class EnergyMagazineExtension : ContentPage
    {
        public EnergyMagazineExtension()
        {
            InitializeComponent();

            ContentLoader_Hopups contentLoader = new ContentLoader_Hopups(ContentLoader_Hopups.Hopups.EnergyMagazineExtension, PageContent);
