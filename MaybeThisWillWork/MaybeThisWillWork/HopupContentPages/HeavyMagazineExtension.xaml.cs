...
namespace MaybeThisWillWork.HopupContentPages
{
    ...
    public partial class HeavyMagazineExtension : ContentPage
    {
        public HeavyMagazineExtension()
        {
            InitializeComponent();

            ContentLoader_Hopups contentLoader = new ContentLoader_Hopups(ContentLoader_Hopups.Hopups.HeavyMagazineExtension, PageContent);
