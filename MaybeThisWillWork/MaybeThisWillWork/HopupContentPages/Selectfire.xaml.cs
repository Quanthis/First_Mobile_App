...
namespace MaybeThisWillWork.HopupContentPages
{
    ...
    public partial class Selectfire : ContentPage
    {
        public Selectfire()
        {
            InitializeComponent();

            ContentLoader_Hopups contentLoader = new ContentLoader_Hopups(ContentLoader_Hopups.Hopups.SelectiveReceiver, PageContent);
