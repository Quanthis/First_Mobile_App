...
namespace MaybeThisWillWork.HopupContentPages
{
    ...
    public partial class Turbocharger : ContentPage
    {
        public Turbocharger()
        {
            InitializeComponent();

            ContentLoader_Hopups contentLoader = new ContentLoader_Hopups(ContentLoader_Hopups.Hopups.Turbocharger, PageContent);
