...
namespace MaybeThisWillWork.HopupContentPages
{
    ...
    public partial class DoubleTapTrigger : ContentPage
    {
        public DoubleTapTrigger()
        {
            InitializeComponent();

            ContentLoader_Hopups contentLoader = new ContentLoader_Hopups(ContentLoader_Hopups.Hopups.DoubleTapTrigger, PageContent);
