...
namespace MaybeThisWillWork.HopupContentPages
{
    ...
    public partial class Skullpiercer : ContentPage
    {
        public Skullpiercer()
        {
            InitializeComponent();

            ContentLoader_Hopups contentLoader = new ContentLoader_Hopups(ContentLoader_Hopups.Hopups.Skullpiercer, PageContent);
