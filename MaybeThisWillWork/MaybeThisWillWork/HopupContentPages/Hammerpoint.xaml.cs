...
namespace MaybeThisWillWork.HopupContentPages
{
    ...
    public partial class Hammerpoint : ContentPage
    {
        public Hammerpoint()
        {
            InitializeComponent();

            ContentLoader_Hopups contentLoader = new ContentLoader_Hopups(ContentLoader_Hopups.Hopups.Hammerpoint, PageContent);
