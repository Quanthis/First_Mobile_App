...
namespace MaybeThisWillWork.OpticsContentPages
{
    ...
    public partial class Classicx2 : ContentPage
    {
        public Classicx2()
        {
            InitializeComponent();

            ContentLoader_Optics contentLoader = new ContentLoader_Optics(ContentLoader_Optics.Sights.Classicx2, PageContent);
            contentLoader.Fill();
